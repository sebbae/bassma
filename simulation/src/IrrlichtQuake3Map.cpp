...
int main()
{
	...
	*/
	device->getFileSystem()->addFileArchive("/home/sebastian/projects/bassma/radiant/baseq3/court.pk3"); //"/home/sebastian/projects/bassma/irrlicht/irrlicht-1.8.1/media/map-20kdm2.pk3");
	...
	*/
	scene::IAnimatedMesh* mesh = smgr->getMesh("court.bsp"); //"20kdm2.bsp");
...
//		node = smgr->addMeshSceneNode(mesh->getMesh(0));
	...
	*/
	if (node)
		node->setPosition(core::vector3df(0,0,0));//-1300,-144,-1249));
